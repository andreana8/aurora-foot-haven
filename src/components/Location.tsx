const Location = () => {
  return (
    <section id="asukoht" className="py-20 bg-background">
        ...
        <div className="grid md:grid-cols-2 gap-10 items-start">
          <div className="space-y-4">
            ...
            <div className="space-y-1 text-muted-foreground">
              <p className="font-bold text-foreground">Aadress:</p>
              <p>Kadaka Trade Center, Kadaka tee 42B, Tallinn, 12919</p>
            </div>
            <p className="text-muted-foreground">
              Paremal pool sissepääs B, 2. korrusele saab ka liftiga.
            </p>
            <p className="text-muted-foreground">
              <span className="font-bold text-foreground">Parkimine:</span> B-sissepääsu vastas, tasuta (registreerida trepikojas oleval monitoril)
            </p>
          </div>
